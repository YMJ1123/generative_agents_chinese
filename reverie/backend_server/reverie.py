...
class ReverieServer:
    ...
    while (True):
      ...
      if check_if_file_exists(curr_env_file):
        ...
        if env_retrieved:
          ...
          movement_folder_path = os.path.join(sim_folder, 'movement')
  ...
  def open_server(self):
    ...
    print ("注意：此模擬包中的代理是由生成代理架構和LLM驅動的計算結構。我們")
    print ("明確這些代理缺乏類似人類的代理能力、意識和獨立決策能力。\n---")
    # print ("")
...
if __name__ == '__main__':
  ...
  origin = input("輸入forked模擬的名字：").strip()
  target = input("輸入新模擬的名字：").strip()
