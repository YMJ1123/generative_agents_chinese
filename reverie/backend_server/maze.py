...
class Maze:
  def __init__(self, maze_name):
    ...
    env_matrix = "../../environment/frontend_server/static_dirs/assets/the_palace/matrix/"
    ...
    meta_info = json.load(open(f"../../environment/frontend_server/static_dirs/assets/the_palace/matrix/maze_meta_info.json", encoding='utf-8'))
